...
document.addEventListener("DOMContentLoaded", () => {
    ...
    popup.id = "popup";
    popup.className = "fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-800 p-5 shadow-lg rounded hidden";
    document.body.appendChild(popup);
    
    const popupText = document.createElement("p");
    popupText.className = "text-black dark:text-white";
    popupText.innerText = "Ceci est un popup";
