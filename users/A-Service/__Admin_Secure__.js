async function verifierCompte() {
    ...
    try {
        ...
        if (fileContent.CompteInfo.Email === email && fileContent.CompteInfo.MDP === password) {
            ...
            // Vérification du champ Permissions dans les détails
            if (fileContent.Details.Permissions === "true") {
                console.log("Utilisateur avec accès Permissionsistrateur");
                // L'utilisateur est un Permissions, pas de redirection
            } else {
