...
<div class="w-full max-w-2xl my-8 md:my-16 flex flex-col items-center px-4 py-8 border-2 border-dashed border-gray-400 dark:border-gray-400 shadow-lg rounded-lg">
    ...
    <div class="w-full flex justify-center">
        <img class="rounded-full mb-4 shadow-lg" style="height: 120px; width: 120px; object-fit: cover;" src="" id="COMPTE:ProfilInfo-Pdp">
    </div>
